...
Birthday* initBirthdayList(int, int, int, int, char[N]);//Инициализация списка для таблицы Дни рождения
Birthday* AddBirthday(Birthday*, int, int, int, int, char[N]);//добавляет запись в таблицу Дни рождения
...
Celebration* initCelebrationList(int, int, int, char[N]);//Инициализация списка для таблицы Праздники
Celebration* AddCelebration(Celebration*, int, int, int, char[N]);//добавляет запись в таблицу Праздники
...
Event* initEventList(int, int, int, int, char[N]);//Инициализация списка для таблицы События
Event* AddEvent(Event*, int, int, int, int, char[N]);//добавляет запись в таблицу События
...
Birthday* initBirthdayList(int id, int dd, int mm, int yy, char fio[N])
{
	Birthday *lst;
...
Birthday* AddBirthday(Birthday* A, int id, int dd, int mm, int yy, char fio[N])
{
	Birthday *temp, *p;
...
Celebration* initCelebrationList(int id, int dd, int mm, char name[N])
{
	Celebration *lst;
	// выделение памяти под корень списка
...
Celebration* AddCelebration(Celebration* A, int id, int dd, int mm, char name[N])
{
	Celebration *temp, *p;
...
Event* initEventList(int id, int dd, int mm, int yy, char description[N])
{
	Event *lst;
	// выделение памяти под корень списка
...
Event* AddEvent(Event* A, int id, int dd, int mm, int yy, char description[N])
{
	Event *temp, *p;
